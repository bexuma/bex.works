...
export const DocumentFactoryCard = () => (
  <Card heading="Document factory">
    <p>
      ...
      directly to the cloud. The new architecture, built on a clear folder
      hierarchy of{' '}
    ...
    <div>
      ...
      <Image
        ...
        width={1600}
        height={972}
        sizes="(min-width: 1536px) 60vw, (min-width: 1280px) 50vw, 100vw"
        placeholder="blur"
        blurDataURL="data:image/webp;base64,UklGRjYAAABXRUJQVlA4ICoAAACwAQCdASoQAAoAAsBMJaQAAudVXdGAAP75cTjmhTwrt0J/bc46TRlQsAA="
